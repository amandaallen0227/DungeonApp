...
namespace DungeonLibrary
{
    public class Location
    {
        public static string GetLocation()
        {
            ...
            //The land of Uz
            "You cautiously venture forward a  sacred temple. You're immediately met by a foreboding city. Rocks cover virtually every surface you can see, which makes traversing this landscape tricky and dangerous. You could've sworn something touched your leg just now, perhaps to inspect you or to get a taste. The LAND OF UZ is no picnic. Not all the creatures seem content with your presence, one begins to come towards you...",
